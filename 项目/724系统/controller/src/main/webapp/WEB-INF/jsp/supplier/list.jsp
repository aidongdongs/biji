<%@ page import="com.show.service.ISupplierService" %>
<%@ page import="org.springframework.beans.factory.annotation.Autowired" %>
<%@ page import="com.show.pojo.Supplier" %>
<%@ page import="java.util.List" %>
<%@ page import="com.show.service.impl.SupplierServiceImpl" %>
<%@ page import="org.springframework.context.ApplicationContext" %>
<%@ page import="org.springframework.context.annotation.AnnotationConfigApplicationContext" %>
<%@ page import="com.show.config.SpringConfig" %>
<%@ page import="com.show.mapper.SupplierMapper" %>
...
<div class="right">
        ...
        <div class="search">
        	<form method="get" action="${pageContext.request.contextPath }/sys/supplier/list">
				...
				<a href="${pageContext.request.contextPath}/route/supplier/toAdd">添加</a>
			</form>
        </div>
        <!--供货商操作表格-->
