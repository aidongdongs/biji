...
| @Autowired                                                   | 名称 |
| ------------------------------------------------------------ | ---- |
| 属性注解  或  方法注解（了解）  或  方法形参注解（了解）     | 类型 |
| 属性定义上方  或  标准set方法上方  或  类set方法上方  或  方法形参前面 | 位置 |
| 为引用类型属性设置值                                         | 作用 |
| required：true/false，定义该属性是否允许为null               | 属性 |
...
| 方法注解                               | 类型 |
| 方法定义上方                           | 位置 |
| 设置该方法的返回值作为spring管理的bean | 作用 |
| value（默认）：定义bean的id            | 属性 |
